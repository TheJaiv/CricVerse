...
from core.subscription_manager import get_all_players, get_tier_status, get_auth_admins
...
try:
    ...
    print(f"Career UI not loaded ({_career_err}); Career commands disabled.")
    _CAREER_OK = False
