...
# Run from repo root: python tools/toss_sweep.py [n] [odi|t20] [pitch1,pitch2,...]
import os
import random
import sys
...
def main():
    ...
    tasks = [(p, n, fmt, 1000 + i) for i, p in enumerate(pitches)]
    tf = tn = 0
